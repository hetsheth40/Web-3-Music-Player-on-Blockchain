  ...
  return (
    <BrowserRouter>
      <div className="App">
        ...
        <div>
          {loading ? (
            <div style={{ display: 'flex', justifyContent: 'center', alignItems: 'center', minHeight: '80vh', height: '100%' }}>
              <Spinner animation="border" style={{ display: 'flex' }} />
              <p className='mx-3 my-0 text_color'>Awaiting Metamask Connection...</p>
            </div>
          ) : (
            <Routes>
              <Route path="/" element={
